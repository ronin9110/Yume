...
class VoiceroomSearchPage extends StatefulWidget {
  static const String routeName = '/voiceroomSearch';
  final SongHandler songHandler;
  const VoiceroomSearchPage({super.key, required this.songHandler});

  @override
  State<VoiceroomSearchPage> createState() => _SearchPageState();
}

class _SearchPageState extends State<VoiceroomSearchPage> {
